...
public class SpringManagedTransaction implements Transaction {
    ...
    private void openConnection() throws SQLException {
        // 获得连接
        // 此处获取连接，不是通过 DataSource#getConnection() 方法，而是通过
        // org.springframework.jdbc.datasource.DataSourceUtils#getConnection(DataSource dataSource) 方法，
        // 获得 Connection 对象。而实际上，基于 Spring Transaction 体系，如果此处正在事务中时，已经有和当前线程绑定的 Connection 对象，
        // 就是存储在 ThreadLocal 中
    ...
    @Override
    public void close() {
        //此处关闭连接，不是通过 Connection#close() 方法，
